...
export default function Início() {
  ...
  return (
    <section
      ...
      } overflow-hidden relative font-mono bg-stone-950 min-h-screen text-white flex flex-col items-center justify-center sm:py-72 py-60 sm:space-y-20 space-y-10`}
      ref={refInicio}
    >
